...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, SnackbarComponent, LoaderComponent],
...
export class IkigaiHomepageComponent {
  ...
  snackbarType!:string;
  ikigaiTeamID!:string;
  constructor(private getHomePageDataService: getHomePageDataService,private router:Router) { }
  ngOnInit(): void {
    console.log('IkigaiHomepageComponent');
